...
import { Lock, Mail, Slack, User } from 'lucide-react';
...
const SignUpPage = () => {
    ...
    return (
        ...
        >
            <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden justify-center">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm opacity-70">
                                        Join SkillShare and start your learning adventure!
                                    </p>
                                </div>
